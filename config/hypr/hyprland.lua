...
-- Match displays by EDID description so the configuration does not depend on
-- which DisplayPort connector each monitor is plugged into.
hl.monitor({
    output   = "desc:Samsung Electric Company LC34G55T HNTX200113",
    mode     = "3440x1440@165",
    position = "0x0",
    scale    = 1,
})
...
hl.monitor({
    output   = "desc:Microstep MAG 275UD E14 CE8M155800657",
    mode     = "3840x2160@120",
    position = "3440x0",
    scale    = 1.5,
})
...
hl.bind("CTRL + SHIFT + SPACE", hl.dsp.exec_cmd("sh ~/.config/hypr/scripts/screenshot.sh fullscreen"))

-- Screen Recorder: save to ~/Videos/
hl.bind("CTRL + SHIFT + R", hl.dsp.exec_cmd("sh ~/.config/hypr/scripts/screenrecord.sh"))
